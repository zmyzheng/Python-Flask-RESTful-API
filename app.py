...
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False   # 只是disable flask的拓展支持，并不disable SQL alchemy的本身的支持
app.config['PROPAGATE_EXCEPTIONS'] = True  # 使flask_jwt_extended能够返回自己的error code 如401
...
def create_tables():
    db.create_all()  # 只创建这个文件import的resource对应的model
